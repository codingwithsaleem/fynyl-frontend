      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl p-8 shadow-lg">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-[#8898f0] mb-6">fynyl.</h1>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[#8898f0] text-sm font-medium">
                      Email/Phone Number
                    </FormLabel>
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 h-12 border-[#e5e7eb] rounded-xl focus:border-[#8898f0] focus:ring-[#8898f0]"
                        />
                      </div>
                    </FormControl>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input
                          ...
                          placeholder="••••••••••"
                          className="pl-10 pr-10 h-12 border-[#e5e7eb] rounded-xl focus:border-[#8898f0] focus:ring-[#8898f0]"
                        />
                        <button
                          type="button"
          ...
          <div className="flex justify-center space-x-4 mb-6">
            <Button
              ...
              variant="outline"
              size="icon"
              className="w-12 h-12 rounded-xl border-[#e5e7eb] hover:border-[#8898f0] bg-transparent"
          ...
          <div className="text-center">
            <span className="text-[#383838] text-sm">
              ...
              <button className="text-[#8898f0] font-medium hover:underline">
                Sign Up
              </button>
            </span>
          </div>
