    ...
    >
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 pt-16 pb-20">
        ...
        <div className="flex justify-center mb-12">
          <div className="rounded-full px-8 py-3 text-white font-medium bg-[#8F8DEB]/45 lg:text-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#383838] text-lg md:text-xl max-w-3xl mx-auto mb-12 leading-relaxed">
            Make your documents shine. Our top-rated solution handles every step—from creation to eSigning—with ease.
          </p>

          <Button
            size="lg"
            className="rounded-full px-8 py-4 text-white font-medium text-lg"
